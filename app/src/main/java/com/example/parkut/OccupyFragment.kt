...
import kotlinx.android.synthetic.main.listing_fragment.view.reserve
import okhttp3.Call
 ...
 * [OccupyFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [OccupyFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class OccupyFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
       ...
       val view = inflater.inflate(R.layout.fragment_occupy, container, false)
        view.occupy1.setOnClickListener{
            doAsync {
                occupy()
            }
...
return view;
    ...
    companion object {
         ...
         * @return A new instance of fragment OccupyFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                OccupyFragment().apply {
